...
public class AIMove1023 : AIMoveBase
{
	...
	public AIMove1023(EntityBase entity, int range)
		: base(entity)
	{
		this.range = range;
	}
	...
	{
		GameLogic.Release.MapCreatorCtrl.RandomItem(m_Entity, range, out float endx, out float endz);
	...
	private void UpdateMoveData()
	{
		...
		else if (findpath != null && findpath.Count > 0)
		{
			UpdateDirection();
